...
export default function NuovaAnagraficaPage() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await fetch("http://localhost:8000/api/anagrafica/full", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-2xl font-bold text-text-main">Nuova Anagrafica</h1>
          <p className="text-text-muted mt-1">Inserimento completo di una nuova anagrafica.</p>
        </div>
